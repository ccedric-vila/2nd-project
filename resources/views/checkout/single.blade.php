                                ...
                                <div class="card border-0 shadow-sm mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-control-plaintext">{{ Auth::user()->contact_number ?? 'Not provided' }}</div>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Shipping Address</label>
                                            <div class="form-control-plaintext">{{ Auth::user()->address ?? 'Not provided' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card border-0 shadow-sm mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-control-plaintext">{{ $product->size }}</div>
                                        </div>
                                    </div>
                                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function updateTotals() {
            try {
                ...
                // Make AJAX request
                const response = await fetch("{{ route('checkout.update-quantity') }}", {
                    method: 'POST',
                    headers: {
