            ...
            <div class="col-lg-10">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="row">
                            <div class="col-md-4 mb-4">
                                <a href="{{ route('admin.supplier.index') }}" class="admin-card-link">
                            ...
                            <div class="col-md-4 mb-4">
                                <a href="{{ route('admin.product.index') }}" class="admin-card-link">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-4">
                                <a href="{{ route('admin.orders.index') }}" class="admin-card-link">
                            ...
                            <div class="col-md-4 mb-4">
                                <a href="{{ route('admin.sales.index') }}" class="admin-card-link">
                            ...
                            <div class="col-md-4 mb-4">
                                <a href="{{ route('admin.reviews.index') }}" class="admin-card-link">
                ...
                <div class="text-center mt-4">
                    <p class="text-muted animate__animated animate__fadeIn" style="font-family: 'Poppins', sans-serif; font-size: 0.9rem;">
                        StyleSphere Admin Panel © {{ date('Y') }} | <span class="badge badge-pill badge-light shadow-sm">v2.0</span>
                    </p>
                </div>
            </div>
        </div>
