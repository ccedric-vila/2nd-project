...
<script>
    ...
    function loadChartData(params = {}) {
        ...
        fetch(`<?php echo e(route('admin.sales.analytics.data')); ?>?${queryString}`)
            .then(response => {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp5\htdocs\stylesphere\resources\views/admin/sales/analytics.blade.php ENDPATH**/ ?>