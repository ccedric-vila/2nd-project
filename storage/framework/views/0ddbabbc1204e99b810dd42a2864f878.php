...
<div class="container">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <!-- Import Form -->
            <form id="importForm" action="<?php echo e(route('admin.products.import.submit')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp5\htdocs\stylesphere\resources\views/admin/product/import.blade.php ENDPATH**/ ?>