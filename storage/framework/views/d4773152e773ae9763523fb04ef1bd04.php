                ...
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-around flex-wrap">
                            ...
                            <a href="<?php echo e(route('admin.sales.index')); ?>" class="btn btn-secondary btn-lg mb-3 animate__animated animate__fadeInUp" style="min-width: 200px;">
                                <i class="fas fa-receipt mr-2"></i> Sales Records
                            </a>
