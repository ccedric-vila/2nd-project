            ...
            <div class="card border-0 shadow-lg">
                ...
                <div class="card-body p-4">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-end mt-3">
                                        ...
                                        <div class="text-end">
                                            <h4 class="text-primary mb-0">$<?php echo e(number_format($product->sell_price, 2)); ?></h4>
                                            <small class="text-success">
                                                <i class="fas fa-check-circle"></i> In Stock: <?php echo e($product->stock); ?>
                    ...
                    <form action="<?php echo e(route('checkout.process')); ?>" method="POST" class="needs-validation" novalidate>
                        ...
                        <input type="hidden" name="max_stock" value="<?php echo e($product->stock); ?>">
                                ...
                                <div class="card border-0 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between mb-2">
                                            <span>Subtotal:</span>
                                            <span>$<?php echo e(number_format($product->sell_price, 2)); ?></span>
                                        </div>
                                        <div class="d-flex justify-content-between mb-2">
                                            <span>Shipping:</span>
